...
export default function App(){
  ...
  function sharePayslip(emp,d,m2,y){
    ...
    try{
      ...
      doc.text("Generated by Admin HR | "+new Date().toLocaleDateString("en-IN"),105,ly+20,{align:"center"});
