...
export default function App(){
  ...
  var makeInIndiaBadge=h("div",{style:{textAlign:"center",padding:"0 0 20px",marginTop:"auto"}},
    h("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:6}},
      h("div",{style:{fontSize:9,color:T.AUTH_LABEL,letterSpacing:.5}},"A product of"),
      h("img",{src:ELEVEN_LOGO,alt:"Eleven.M",style:{height:28,objectFit:"contain",borderRadius:8,opacity:.9}})
    )
  );
